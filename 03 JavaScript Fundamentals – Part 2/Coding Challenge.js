...
//Solution
// require 1 Create an array 'bills'
const bills = [22, 295, 176, 440, 37, 105, 10, 1100, 86, 52];
//require 2 empty arrays for the tips and the totals
const tips = [];
const totals = [];
// require 3 crete 'calcTip' function
const calcTip = function (bill) {
    for (let i = 0; i < bill.length; i++) {
        if (bill[i] >= 50 && bill[i] <= 300) {
            tips.push(bill[i] * 0.15)
            totals.push(bill[i] * 0.15 + bill[i])
        } else {
            tips.push(bill[i] * 0.2)
            totals.push(bill[i] * 0.2 + bill[i])
        }
    }
}
//call function
...
//print to test data
console.log('bills', bills, '\n', 'tips', tips, '\n', 'totals', totals)
//require 4 Write a function 'calcAverage'
/*test()
function test(){
    console.  log('test call function before definition')
}*/
...
/*
const test=[1,2,3] //to test calcAverage function
